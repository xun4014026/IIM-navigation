...
public class destinationSearchActivity extends AppCompatActivity implements SearchView.OnQueryTextListener {

    // Declare Variables
    ListView list;
    ListViewAdapter adapter;
    SearchView editsearch;
    private static final int REQUEST_CODE_DEST = 2;
    ArrayList<String> data = new ArrayList<String>();
    private static String des_previous_choice = "選擇目的地";//default
...
//            data.add("我的位置");
    ...
    public boolean onQueryTextSubmit(String query) {
        ...
        if(exist){
            ...
            // 換成新的寫法
            des_previous_choice = query;
            Intent intent = getIntent();
            intent.putExtra("ListItemContent", query);//xin1116
            setResult(REQUEST_CODE_DEST, intent);
            finish();
    ...
    {   // 按了 Android 裝置的實體返回鍵
        ...
        mIntent.putExtra("ListItemContent", des_previous_choice);
        Log.d("leosu", "onBackPressed_previous_choice: "+des_previous_choice);
